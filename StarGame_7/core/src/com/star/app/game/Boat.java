...
public class Boat implements Ship, Poolable {
...
//    protected int weaponNum;
    ...
    public Boat(GameController gc, int hpMax, float enginePower) {
        this.gc = gc;
        this.hpMax = hpMax;
        this.hp = hpMax;
        ...
        this.active = false;
//        createWeapons();
        this.currentWeapon = new Weapon(gc,this,"Laser", 0.2f, 1, 600.0f, 500,
                        new Vector3[]{
                                new Vector3(28, 0, 0),
    ...
    public void activate(float x, float y, float vx, float vy, float scale) {
        ...
        currentWeapon = new Weapon(gc,this,"Laser", 0.2f, 1, 600.0f, 500,
                new Vector3[]{
                        new Vector3(28, 0, 0),
                        new Vector3(28, 90, 20),
                        new Vector3(28, -90, -20)
